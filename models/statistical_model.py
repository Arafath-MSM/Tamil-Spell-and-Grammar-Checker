...
class StatisticalChecker:
    def __init__(self):
        ...
        # Training data - Expanded dataset with new examples
        self.train_texts = [
            "அவன் பள்ளிக்கு செல்கிறான்",
            "அவள் வீட்டிற்கு செல்கிறாள்",
            "நாங்கள் புத்தகம் படிக்கிறோம்",
            "நான் வகுப்புக்கு செல்லுகிறேன்",
            "அவர்கள் கடைக்கு செல்கிறார்கள்",
            "நீங்கள் உணவுக்கு வருகிறீர்கள்"
        ]
